<!--campos variados para la cabecera -->
...
?>
  ...
  <main class=" imagen contenido-principal imagen col-12 col-sm-10 col-md-4 col-xxl-4">
  ...
  <div class="column col-6 offset-3">
    ...
    <aside class="col-md-8">
     ...
     <p class="d-none d-md-block">4 Columnas</p>
      ...
      <div class="columna  col-12 col-md-12" style="text-align:right">
...
<div class="row">
          ...
          <div class="col-6">
            ...
            <button type="button"  id="btnBuscarNota" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalbuscarNota">
              Buscar Nota </button>
...
<div class="6">
        ...
        <button type="button"  id="btnMayorista" class="btn btn-info"  onclick="ftnCambiarPrecio(this)">
          Mayorista</button>
        ...
        <button type="button" id="btnTaller" class="btn btn-info"  onclick="ftnCambiarPrecio(this)">
          <span translate="no">Taller</span></button>





        <button type="button" id="btnPublico" class="btn btn-info"  onclick="ftnCambiarPrecio(this)">
          Publico</button>
...
<div class="col-sm-12 tablero" style="text-align:center; margin-top:2%">

      <!--<div class="table-responsive-md table-hover table-striped "style="height:300px;overflow:auo">-->

             <table id="tblProductos" name="tblProductos" class=" table-responsive">
                <thead class="tablero">
                  <tr class="active">
                    <th style="width:140px">codigo de barras</th>
                    <th style="width:20px">Existe</th>
                    <th style="width:400px "scope="col-">Nombre</th>
                    <th style="width:100px "scope="col">Marca</th>
                    <th style="width:160px " scope="col">P.Unitario</th>
                    <th style="width:50px " scope="col"><span translate="no">CAN</span></th>
                    <th style="width:50px "scope="col">Accion</th>
      ...
      <!--<div class="table-responsive"style="height:250px;overflow:auto">-->
        ...
        <table id="tblCompra" name="tblCompra" class="table-responsive">
                <thead class="tablero">
                  <tr class="active">
                    ...
                    <th style="width:150px;">Codigo de Barras</th>
                    <th style="width:450px"scope="col-4">Nombre</th>
                    <th  style="width:100px "scope="col">Proveedor</th>
                    <th style="width:120px "scope="col">Precio</th>
                    <th style="width:50px"scope="col">CANTI</th>
...
<!-- Inicia modal Buscar Clientes -->
    <div
                  ...
                  <button type="button" class="btn btn-info" id="btnAgregarCliente" onclick="ftnCrearModalInsertarClienteModal()">Agregar</button>
      ...
      >
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancelar</button>
              <button type="button"onclick="ftnquitarpreProducto()" class="btn btn-primary">Acepto</button>
            </div>
          </div>
        </div>
      </div>
...
<!-- inicia  Abonar  modalNota -->
<div
        class="modal fade"
        id="modalbuscarNota"
        tabindex="-1"
        aria-hidden="true"
        aria-labelledby="modalbuscarNotaLabel"
        data-bs-backdrop="static"
      >
        <!-- Caja de dialogo -->
        <div class="modal-dialog modal-dialog-scrollable">
          ...
          <!-- Contenido de la caja -->
          <div class="modalsaid-lg modalsaid modalsaid-md modal-content modal-dialog-scrollable">
            <!-- Encabezado de la caja -->
            <div class="modal-header">
            ...
            <!-- Cuerpo de la caja -->
            <div class="modalsaid-body-lg modal-body-said-md modal-body-said modal-dialog-scrollable">
              <div style="">
              ...
              <?php include 'modales/Modbuscarnota.php'; ?>
...
<!-- termina modal abonar -->
<!-- Inicia modal control generico -->
<div
  					class="modal fade"
  					id="modalGenerico"
  					tabindex="-1"
  					aria-hidden="true"
  					aria-labelledby="modalGenericoLabel"
  					data-bs-backdrop="static"
  				>
  					<!-- Caja de dialogo -->
  					<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
  						...
  						<div class="modal-content">
  							<!-- Encabezado de la caja -->
  							<div class="modal-header">
  								<h5 class="modal-title" id="TituloModalGenerico">VENTA  A CREDITO O CONTADO</h5>
                      ...
                      <!--Fin del Cuerpo del modal-->
  							...
  							<div class="modal-footer">
  								<button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancelar</button>
  								<button type="button" id="btnModalGenericoAceptar" class="btn btn-primary">Acepto</button>
  							</div>
  						</div>
  					</div>
  				</div>
<!-- termina  modal control generico -->
...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.3/dist/umd/popper.min.js" integrity="sha384-eMNCOe7tC1doHpGoWe/6oMVemdAVTMs2xqW4mwXrXsW0L84Iytr2wi5v2QjrP/xp" crossorigin="anonymous"></script>
    ...
    <script src="https://unpkg.com/html5-qrcode@2.0.9/dist/html5-qrcode.min.js"></script>
        ...
        <script type="text/javascript" src="../js/CreacionObjetosjs.js"></script>
        <script type="text/javascript" src="../js/clienteEnventasjs.js"></script>
