	...
	<header class="container my-5">
		<div class="nav row g-0 justify-content-between rounded-top">
			...
			<div class="logo col-12 col-lg-auto d-flex align-items-center justify-content-center ps-4">
				<span  translate ="no" class="fw-bold text-uppercase mb-0" >Zugelly Cabrera</span>
				<div cla-ss="icono">
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
						<path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
					</svg>
				</div>
				<p class="mb-0"> Representante  Tel: 7341136805</p>
			</div>
		...
		<div class="container">
			...
			<div class="row acerca-de align-items-center px-4 mb-5">
				<div class="col-12 col-lg-4 foto text-center">
					...
					<span translate="no"><p class="nombre">Zugelly Cabrera</p></span>
					<a href="app-release-2.apk" download="app-release-2.apk">Download APP (aplicaicion Adroid MEFAC para celular)</a>
				</div>

				<div class="col-12 col-lg-8 info">
					<h2 class="titulo text-center text-lg-start">Acerca de</h2>
					<p class="resumen">Esta pagina es para bayudar a todas las personas que sufren violencia domestica</p>
					
					<p class="resumen">La fundación MEF-AC inicio como un proyecto de atención a las demandas de mujeres víctimas de violencia en el municipio de Tlaltizapán, durante un tiempo en el cual los índices de casos de violencia contra las mujeres se incrementaron considerablemente</p>
