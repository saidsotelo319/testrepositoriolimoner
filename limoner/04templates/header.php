...
<header class="fixed-top">
    <div class="container-fluid">
      <div class="row ">
        ...
        <div class="col-2 col-lg-3 col-xl-2 d-flex align-items-center order-1">
          <a href="https://mcbross.com/" class="logo me-2">
          <img src="img/5060mcbross.jpg" class="rounded-circle" height="50"alt="">

          </a>
          <div class="col-2 col-md-1 col-lg-2 barra-busqueda d-none d-sm-block">
            <div class="icono">
...
<div class="row">
    ...
    <div class="col-2">
          ...
          <a href="http://mc-bros.com.mx/pruebas/ClientesV1.php">
    ...
    <div class="col-2">
            <a href="https://mc-bros.com.mx/ventasPrueba/existencias.php">
    ...
    <div class="col-2">
          ...
          <a href="https://mc-bros.com.mx/ventasPrueba/ventas4.php">
    ...
    <div class="col-2">
        ...
        <nav class="botones col-auto col-lg-3 col-xl-2 text-end d-flex align-items-center justify-content-end order-2 order-lg-3">
          <a href="#" class="perfil">
            <img src="<? echo $Mycarpetaimagen ?><? echo $MyFoto ?>.png"  alt=""> <?echo $MyUsuario ?>
